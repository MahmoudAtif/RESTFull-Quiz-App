...
class TestModel(TestCase):
    ...
    def setUp(self):
        ...
        self.quiz = Quiz.objects.create(title='Test Quiz', category=self.category,
                                        started_at="2023-01-08T10:00:00+02:00", ends_on="2023-01-08T11:00:00+02:00")
        self.question = Question.objects.create(
            quiz=self.quiz, title='Test Quetion', degree=1, technique='MultipleChoices', level='Beginner', is_active=True)
        self.question_choice = QuestionChoice.objects.create(
            question=self.question, title='Test Choice', is_correct=True)
